...
from src.hsm_robot.hsm_msg_constants import HSM_EVENTS, HSM_TICK_EVENT
...
class CodeGenerator:
    ...
    def __init__(self, graph_file, **kwargs):
        ...
        self.__template_handlers = {
            ...
            'SM_HAS_TICKS': (hsm_messages.HSM_TICK_EVENT in self.__sm_signals) or (EMPTY_EVENT in self.__sm_signals),
            'SM_HAS_SECONDS': hsm_messages.HSM_TICK_1S_EVENT in self.__sm_signals,
            'SM_HAS_MINUTES': hsm_messages.HSM_TICK_1M_EVENT in self.__sm_signals,
    ...
    def __write_generator_info(self, f):
        ...
        self.__w(f, '# Generated by HSM-to-ROS2 script version {}\n\n'.format(self.VERSION))
